...
/**
 * 使用 {@link SelectableServiceLoaderImpl} 替代
 *
 * @param <Param_Type>
 * @param <T>
 * @see org.coodex.util.SelectableServiceLoader
 * @deprecated
 */
@Deprecated
public abstract class AcceptableServiceLoader<Param_Type, T extends AcceptableService<Param_Type>>
        extends SelectableServiceLoaderImpl<Param_Type, T>
