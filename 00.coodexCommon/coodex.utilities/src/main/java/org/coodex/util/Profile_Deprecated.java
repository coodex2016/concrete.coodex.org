 ...
 */
@Deprecated
public class Profile_Deprecated extends Profile implements StringMap {
    protected Profile_Deprecated(String path) {
        super(path);
    }

//    private static final String RELOAD_INTERVAL = System.getProperty("Profile.reloadInterval");
//    private static final Logger log = LoggerFactory.getLogger(Profile_Deprecated.class);
    private static final Map<String, Profile_Deprecated> profiles = new HashMap<String, Profile_Deprecated>();
...
//    }
//
    public synchronized static Profile_Deprecated getProfile(String path) {
        Profile_Deprecated p = profiles.get(path);
        if (p == null) {
            p = new Profile_Deprecated(path);
            profiles.put(path, p);
        }
        return p;
    }
...
//        if (!path.startsWith("/"))
//            path = "/" + path;
//        URL uri = Profile_Deprecated.class.getResource(path);
//
//        if (uri == null) {
...
//                f = null;
//                is = Profile_Deprecated.class.getResourceAsStream(path);
//            } else {
