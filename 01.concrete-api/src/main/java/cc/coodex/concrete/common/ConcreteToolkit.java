...
import cc.coodex.util.ReflectHelper.Processer;
...
//    }
    ...
    public static void foreachIntf(Processer processor, String... packages) {
        foreachClass(processor, CONCRETE_SERVICE_INTERFACE_FILTER, packages);
    }
