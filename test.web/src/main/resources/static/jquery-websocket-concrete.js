...
(function (factory) {
    ...
    register("ServiceExample", "org.coodex.practice.jaxrs.api", { "genericTest": function (x) {return invoke({"serviceId": "29E4C7D6CBC5F8B04992D742D6CD8C75338EBFEA","param": x });}, "all": function () {return invoke({"serviceId": "3D22D8E971A86505E454071BAE873C995D8BA344","param": undefined });}, "add": function (x, y) {return invoke({"serviceId": "0298C57EA3CC54E99993E2973605A483F9295168","param": {"x": x, "y": y} });}, "genericTest1001": function (x) {return invoke({"serviceId": "6B03298353A066981570D6A193B380E204E9CE6B","param": x });}, "genericTest1002": function (x) {return invoke({"serviceId": "E8ED4C6B11618CB81AA07FDB64070E56AC1B0FAB","param": x });}, "tokenId": function () {return invoke({"serviceId": "382E719B18E470546037B313504535DD2BE58111","param": undefined });}, "update": function (bookId, book) {return invoke({"serviceId": "2C2D2CB3456FC97272D7767108C166B49E2AC3F4","param": {"bookId": bookId, "book": book} });}, "delete": function (bookId) {return invoke({"serviceId": "CE3B9E1E4AC73DADD1FE0FBAFF11D3209B6D7784","param": bookId });}, "g5": function (xx) {return invoke({"serviceId": "E80BBFB137019CAC6232458A737DED5B5C2A5929","param": xx });}, "g6": function (gp) {return invoke({"serviceId": "F24CF2C09F088C92CFF8ED01E9F2B9227A88DDA6","param": gp });}, "findByPriceLessThen": function (price) {return invoke({"serviceId": "2CF247ABA7D55EF6523AA10DD3974F93A6CF7DE0","param": price });}, "multiPojo": function (pathParam, body1, body2, body3, body4) {return invoke({"serviceId": "26A79FCE1822D0067EE9215785541EA7C70CFA91","param": {"pathParam": pathParam, "body1": body1, "body2": body2, "body3": body3, "body4": body4} });}, "bigStringTest": function (pathParam, toPost) {return invoke({"serviceId": "390920F46693DB8276D8CA5E893758852B5F5804","param": {"pathParam": pathParam, "toPost": toPost} });}, "get": overload("get", {"2": function (author, price) {return invoke({"serviceId": "8FD81C76EB63054900FEE71E4CCD730DE739DFA8","param": {"author": author, "price": price} });}, "1": function (bookId) {return invoke({"serviceId": "A5921572538BDCAA773D788F3A9292F3CB18B34F","param": bookId });}}), "genericTest5": function (gp) {return invoke({"serviceId": "39D40DB4BC0D379A7D350C2562E0C3BC1E5B9D75","param": gp });}, "genericTest2": function (y) {return invoke({"serviceId": "529F4FE6F3ABA5343680B69C69D45BBADAE47ED6","param": y });}, "findByAuthorLike": function (author) {return invoke({"serviceId": "3DF9E532CE7440BA15897EC6ECFC15A99A8E7A11","param": author });}, "genericTest4": function (gp) {return invoke({"serviceId": "48E10D008E269501607D0FFFB00108A2E427EB98","param": gp });}, "genericTest3": function (z) {return invoke({"serviceId": "B8C1DE8D5430363980C92ED20B54B246D8002E61","param": z });}, "checkRole": function () {return invoke({"serviceId": "CB0503884AE338DCBEF69A149C12864D7C7F89C5","param": undefined });}});
    register("Calc", "org.coodex.practice.jaxrs.api", { "add": function (x, y) {return invoke({"serviceId": "29D006A09884E03E8E9549CA3957EE5C89A0FE8D","param": {"x": x, "y": y} });}});
    if(self){
