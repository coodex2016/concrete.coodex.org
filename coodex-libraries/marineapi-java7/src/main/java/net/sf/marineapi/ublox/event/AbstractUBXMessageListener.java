 ...
 * net.sf.marineapi.nmea.event.AbstractSentenceListener} using {@link net.sf.marineapi.nmea.sentence.UBXSentence} as type.</p>
 * <p>
 * This class is based on {@link net.sf.marineapi.nmea.event.AbstractSentenceListener} and thus it has the
 ...
 * @see net.sf.marineapi.util.GenericTypeResolver
 */
public abstract class AbstractUBXMessageListener<T extends UBXMessage>
	 ...
	 * the {@link net.sf.marineapi.util.GenericTypeResolver} may not always succeed.
	 *
	...
	/**
	 * <p>
	 * Invoked when {@link net.sf.marineapi.nmea.sentence.UBXSentence} of any type is received. Pre-parses
	 * the message to determine it's type and invokes the
	 * {@link #onMessage(net.sf.marineapi.ublox.message.UBXMessage)} method when the type matches the generic
	 * type {@code T}.</p>
	 * <p>
