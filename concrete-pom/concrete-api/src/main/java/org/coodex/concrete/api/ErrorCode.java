 ...
 * <p>
 * <S>获取一个code的模板时，如果指定了ErrorCode.Template.value()，则使用此模板，否则concrete会通过I18N进行搜索, 键为：
 * ErrorCode.value() + '.' + Key.value(); Key.value默认为code的值，ErrorCode.value的默认值为“message”</S>
 */
