...
public class ApacheDubboDestinationFactory extends AbstractDestinationFactory<ApacheDubboDestination> {
    ...
    public Destination build(String module) {
        ApacheDubboDestination dubboDestination = init(new ApacheDubboDestination(), module);
        ...
        dubboDestination.setProtocol(ClientHelper.getString(module, "protocol"));
        dubboDestination.setUrl(ClientHelper.getString(module, "url"));
