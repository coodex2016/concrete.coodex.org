...
public class ProtobufHelper {
    public static Concrete.ResponsePackage toProtobufResponse(ResponsePackage<?> responsePackage) {
        return null;
    }

    public static RequestPackage<Object> toRequest(Concrete.RequestPackage requestPackage) {
        return null;
    }
}
