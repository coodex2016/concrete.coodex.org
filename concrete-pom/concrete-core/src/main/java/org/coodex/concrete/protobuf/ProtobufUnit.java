...
public class ProtobufUnit extends OwnServiceUnit {

    private final String overProtocol;
    public ProtobufUnit(Method method, AbstractModule<?> module, String overProtocol) {
        super(method, module);
    ...
    public String getInvokeType() {
        return "protobuf.over." + overProtocol; // todo
    }
}
