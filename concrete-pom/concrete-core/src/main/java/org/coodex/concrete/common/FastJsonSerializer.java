 ...
 */
@Deprecated
public class FastJsonSerializer extends org.coodex.util.FastJsonSerializer implements JSONSerializer {
//
...
//            parseObject = jsonClass.getMethod("parseObject", String.class, Type.class, Array.newInstance(feature,
//            0).getClass());
//        }
//    }
//
//    private Object $parse(String json, Type t) throws NoSuchMethodException, ClassNotFoundException,
...
//    }
//
//    private String $toJson(Object t) throws InvocationTargetException, IllegalAccessException,
