...
import cc.coodex.concrete.api.ErrorMsg;
import cc.coodex.concrete.core.JavaTextFormatMessageFormatter;
import cc.coodex.concrete.core.ResourceBundlesMessagePatternLoader;
