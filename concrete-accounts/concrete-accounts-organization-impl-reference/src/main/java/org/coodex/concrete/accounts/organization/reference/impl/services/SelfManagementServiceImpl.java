...
import org.coodex.concrete.accounts.organization.impl.AbstractSelfManagementServiceImpl;
...
import org.coodex.concrete.accounts.organization.reference.api.SelfManagementService;
...
//@LogAtomic
//@OperationLog
public class SelfManagementServiceImpl
        extends AbstractSelfManagementServiceImpl
        <Institution, Department, Position, Person,
                InstitutionEntity, DepartmentEntity, PositionEntity, PersonEntity>
        implements SelfManagementService {
