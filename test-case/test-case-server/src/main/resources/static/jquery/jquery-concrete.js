...
(function (factory) {
    ...
    register("Test", "org.coodex.concrete.test.api", { "add": function (x1, x2) {return invoke({"path": "/OrgCoodexConcreteTestApiTest/add/{x1}/{x2}","param": {"x1": x1, "x2": x2},"method": "GET", "dataType": "json" });}, "sayHello": function (name) {return invoke({"path": "/OrgCoodexConcreteTestApiTest/sayHello/{name}","param": {"name": name},"method": "GET", "dataType": "text" });}, "test": function () {return invoke({"path": "/OrgCoodexConcreteTestApiTest/test","param": {},"method": "GET", "dataType": "json" });}, "nullTest": function () {return invoke({"path": "/OrgCoodexConcreteTestApiTest/nullTest","param": {},"method": "GET", "dataType": "json" });}, "bodyTest": function (bodyInt, notBodyInt, bodyStr, notBodyStr) {return invoke({"path": "/OrgCoodexConcreteTestApiTest/bodyTest/{notBodyInt}/{notBodyStr}","param": {"bodyInt": bodyInt, "notBodyInt": notBodyInt, "bodyStr": bodyStr, "notBodyStr": notBodyStr},"method": "POST", "dataType": "json" });}});
